...
const quickLinks = [
  ...
  { href: '/about-us', label: 'Về chúng tôi', external: '' },
];
          ...
          <div className="grid gap-12 md:grid-cols-[1.3fr,1fr,1fr]">
            <div className="space-y-6">
              <div className="flex flex-wrap items-center gap-6">
                <Link href="/" className="flex items-center gap-3">
                  ...
                  />
                  <span
                    className={`text-3xl font-semibold uppercase tracking-[0.18em] ${bigShoulders.className}`}
                  >
                    SportM
                  </span>
                </Link>
            ...
            <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
              <div className="flex flex-col gap-5">
                <h3
                  className={`text-xl font-semibold uppercase tracking-wide text-white ${bigShoulders.className}`}
                >
                  Liên kết nhanh
                </h3>
